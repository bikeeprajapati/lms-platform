...
const Hero: FC<Props> = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-900/95 to-black px-4 py-20">
        ...
        <div className="grid grid-cols-1 gap-8 1000px:grid-cols-2 items-center">
          ...
          <div className="flex justify-center 1000px:justify-start">
            <div className="relative w-[420px] h-[420px] 1100px:w-[560px] 1100px:h-[560px] rounded-full flex items-center justify-center">
              <div className="absolute -inset-12 rounded-full bg-gradient-to-br from-[#1f2937] via-[#0b1220] to-[#0b1220] opacity-90 blur-3xl" />
          ...
          <div className="flex flex-col items-start text-left pt-8 1000px:pt-0">
            <h1 className="font-josefin font-bold text-white text-4xl 1000px:text-6xl 1100px:text-[72px] leading-tight">
            ...
            <div className="mt-8 w-full max-w-2xl">
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-md bg-slate-700/60 placeholder:text-slate-300 py-3 px-4 pr-14 text-slate-100 outline-none"
                />
              ...
              <div className="mt-6 flex items-center gap-3">
                <div className="flex items-center">
                  <div className="h-10 w-10 rounded-full ring-2 ring-white overflow-hidden">
                    <Image src="/assets/client1.jpg" alt="client1" width={40} height={40} className="object-cover" />
                  </div>
                  <div className="h-10 w-10 rounded-full ring-2 ring-white overflow-hidden -ml-5">
                ...
                <p className="font-josefin dark:text-[#edfff4] text-[#d1d5db] 1000px:pl-3 text-[16px] font-[600]">
                  <span className="font-semibold text-white">500K+</span> People already trusted us. 
                  <Link href="/courses" className="ml-2 text-cyan-400">View Courses</Link>
                </p>
              </div>
            </div>
          </div>
